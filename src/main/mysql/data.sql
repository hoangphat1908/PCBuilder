...
VALUES
    ...
    ('Intel', 'Core i7-6700K', 299.99, 4, 4, 91),
    ('Intel', 'Core i7-3770K', 554.05, 4, 3.5, 77),
    ('Intel', 'Core i7-4790K', 333.99, 4, 4, 88),
    ('Intel', 'Core i7-5930K', 557.99, 6, 3.5, 140),
    ('Intel', 'Core i5-3570K', 275, 4, 3.4, 77),
    ('Intel', 'Core i5-6600K', 228.59, 4, 3.5, 91),
    ('Intel', 'Xeon E3-1231 V3', 329.87, 4,3.4,80),
    ('Intel', 'Core i7-4770K', 455.97, 4,3.5,84),
    ('Intel', 'Core i5-6500', 189.58, 4, 3.2,65),
    ('Intel', 'Core i5-4670K', 309.39, 4, 3.4, 84),
    ('Intel', 'Core i5-7600K', 199.89, 4, 3.8, 91),
...
VALUES
    ...
    ('Gigabyte', 'Z370 AORUS GAMING WIFI (rev. 1.0)', 99.99, 'ATX', 'LGA1151',4,64),
    ('Asus', 'ROG RAMPAGE VI EXTREME', 649.99, 'EATX', 'LGA2066', 8, 128),
    ('Gigabyte', 'A-970A-DS3P FX (rev. 2.1)', 48.99, 'ATX', 'AM3+/AM3', 4, 32),
    ('MSI', 'Z370-A PRO', 101.98, 'ATX', 'LGA1151', 4,64),
    ('Asus', 'ROG STRIX Z370-G GAMING (WI-FI AC)', 176.99, 'Micro ATX', 'LGA1151', 4, 64),
    ('Asus', 'ROG STRIX Z370-F GAMING', 191.99, 'ATX', 'LGA1151', 4, 64),
    ('Gigabyte', 'Z370 HD3 (rev. 1.0)', 101.49, 'ATX', 'LGA1151', 4, 64),
    ('Gigabyte', 'Z370 AORUS Ultra Gaming (rev. 1.0)', 119.99, 'ATX', 'LGA1151', 4, 64),
	('Asus', 'STRIX B250H Gaming', 69.99, 'ATX', 'LGA1151', 4, 64),
    ('MSI', 'Z370 GODLIKE GAMING', 484.99, 'EATX', 'LGA1151', 4, 64),
    ('Asus', 'Prime Z370-P', 138.89, 'ATX', 'LGA1151', 4, 64),
    ('MSI', 'A320M PRO-VH PLUS', 41.99, 'Micro ATX', 'AM4', 2, 32);
...
VALUES
    ...
    ('EVGA', 'EVGA 04G-P4-2983-KR', 377.39, 'Superclocked ACX 2.0', 'GeForce GTX 980', 4, 1.27),
    ('EVGA', 'EVGA 02G-P4-2774-KR', 169.99, 'Superclocked ACX', 'GeForce GTX 770', 2, 1.11),
    ...
    ('ASUS', 'ROG STSRIX-GTX1070-O8G-GAMING', 444.98, 'ROG STRIX', 'GeForce 1070', 8, 1.63),
    ('EVGA', 'EVGA 04G-P4-6253-KR', 156.99, 'SC GAMING ACX 2.0', 'GeForce 1050 Ti', 4, 1.35),
    ('MSI', 'MSI GTX 1070 GAMING X 8G', 469.88, 'GAMING X 8G', 'GeForce 1070', 8, 1.51),
...
VALUES
    ...
    ('Corsair', 'Vengeance LPX', 194.88, 16, '2x8GB', '288-pin DIMM', 'DDR4-3000'),
...
VALUES
    ...
    ('Samsung', 'MZ-7PC128B/WW', 199.99, 'SSD', '2.5"', '830 EVO-Series', '128GB', NULL),
...
VALUES
    ...
    ('Noctua', 'NH-D15', 74.95, '900 - 1200 RPM', '12.6 - 19.8 dbA'),
    ...
    ('CRYORIG', 'H100i', 99.99, '2700 RPM', '37.7 dbA'),
...
VALUES
    ...
    ('Fractal Design', 'Focus G (Black)', 39.99, 'ATX Mid Tower', NULL),
